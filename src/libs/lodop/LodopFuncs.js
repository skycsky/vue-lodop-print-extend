...
function getLodop(oOBJECT, oEMBED) {
  ...
  var strHtmInstall =
    ...
    exeUrl +
    " target='_blank'>下载</a>,安装后请刷新页面或重新进入。</font>"
  var strHtmUpdate =
    "<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href=" +
    exeUrl +
    " target='_blank'>下载</a>,升级后请重新进入。</font>"
  ...
  var strHtm64_Update =
    ...
    " target='_blank'>下载</a>,升级后请重新进入。</font>"
  var strHtmFireFox =
    "<br><font color='#FF00FF'>（注意：如曾安装过Lodop旧版附件npActiveXPLugin,请在【工具】->【附加组件】->【扩展】中先卸它）</font>"
  var strHtmChrome =
    "<br><font color='#FF00FF'>(如果此前正常，仅因浏览器升级或重安装而出问题，需重新执行以上安装）</font>"
  ...
  var strCLodopUpdate =
    ...
    exeUrl +
    " target='_blank'>下载</a>,,升级后请刷新页面。</font>"
  var LODOP
  try {
    var ua = navigator.userAgent
    ...
    if (needCLodop()) {
      ...
      if (!LODOP || !LODOP.VERSION) {
        ...
        if (ua.indexOf('Firefox') >= 0)
          MessageBox.alert(
            (is64IE ? strHtm64_Install : strHtmInstall) + strHtmFireFox,
            '提示',
            { dangerouslyUseHTMLString: true },
          )
